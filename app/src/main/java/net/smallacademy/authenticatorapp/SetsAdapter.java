...
import net.smallacademy.authenticatorapp.activity.QuestionsActivity;
...
//                    SetsActivity.selectedCatIndex=position;
            ...
            setDeleteBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    AlertDialog dialog = new AlertDialog.Builder(itemView.getContext()).setTitle(Html.fromHtml("<font color='#FFFFFF'>Delete Set</font>"))
                            .setMessage(Html.fromHtml("<font color='#FFFFFF'>Do you want to delete this  Set ?</font>")).setPositiveButton("YES", new DialogInterface.OnClickListener() {
